...
public class InventoryMain {
	...
	public static void main(String[] args) {
		...
		inv.addPart(null, "01011", "1/2\" Bolt", "Sears", 100, 1, "Facility 1 Warehouse 1");
		inv.addPart(null, "X3599", "1\" Laminate Edging (Hot Pink)", "Plastics R Us", 50, 2, "Facility 1 Warehousr 2");
		inv.addPart(null, "02949", "1/4\" Plywood 10x10", "", 10, 3, "Facility 2");
